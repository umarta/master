<aside id="sidebar_main">
    ...
    <div class="menu_section">
        <ul>
            ...
            <li title="Modul Master">
                <a href="#">
                    <span class="menu_icon"><i class="material-icons">&#xE8F9;</i></span>
                    <span class="menu_title">Modul Master & Set Up</span></a>
                <ul>
                    <li>
                        <a href="#">Master</a>
                        <ul>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Master Type Motor</a></li>
                                    <li><a href="#">Master Grouping Motor</a></li>
                                    <li><a href="#">Master Dealer</a></li>
                                    <li><a href="#">Master Main Dealer</a></li>
                                    <li><a href="#">Master Finance Company</a></li>
                                    <li><a href="#">Master Gudang / Warehouse Dealer</a></li>
                                    <li><a href="#">Master Harga Beli ke MD </a></li>
                                    <li><a href="#">Master Activity</a></li>
                                    <li><a href="#">Master Bundling</a></li>
                                    <li><a href="#">Master Sales Program</a></li>
                                    <li><a href="#">Master Part</a></li>
                                    <li><a href="#">Set Up Jenis Order</a></li>
                                    <li><a href="#">Set Up Jenis Order</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">H2</a>
                                <ul>
                                    <li><a href="#">Master Customer H1</a></li>
                                    <li><a href="#">Master Customer</a></li>
                                    <li><a href="#">Master Pembawa Motor</a></li>
                                    <li><a href="#">Master Pemakai Motor</a></li>
                                    <li><a href="#">Master Pajak Perusahaan</a></li>
                                    <li><a href="#">Master Tipe Motor</a></li>
                                    <li><a href="#">Master Jasa</a></li>
                                    <li><a href="#">Master Jasa </a></li>
                                    <li><a href="#">Master Promo Program</a></li>
                                    <li><a href="#">Detail Promo Program</a></li>
                                    <li><a href="#">Master KPB by Tipe Motor</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
            ...
            <li title="H1">
                <a href="page_mailbox.html">
                    <span class="menu_icon"><i class="material-icons">&#xE158;</i></span>
                    <span class="menu_title">H1</span>
                </a>
                <ul>
                    <li>
                        <a href="#">Modul Master</a>
                        <ul>
                            <li><a href="#">Master Karyawan</a></li>
                            <li><a href="#">Master Type Motor</a></li>
                            <li><a href="#">Master Grouping Motor</a></li>
